...
# ─────────────────────────────────────────────────────────────────────────────
# HTML template — uses {NODES_JSON}, {EDGES_JSON}, {TITLE}, {GENERATED_AT}
# ─────────────────────────────────────────────────────────────────────────────
...
<head>
  ...
  <title>Mr.Holmes OSINT Mindmap — {TITLE}</title>
...
<body>
  <div id="header">
    <h1>🔍 Mr.Holmes OSINT Mindmap — {TITLE}</h1>
    <span>Được tạo lúc: {GENERATED_AT}</span>
  </div>
...
class MindmapGenerator:
    ...
    def generate(self, graph_dict: dict[str, Any]) -> str:
        ...
        title = seed_nodes[0]["target"] if seed_nodes else "OSINT Report"
